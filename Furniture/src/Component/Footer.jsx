...
//   return (
//     <footer className="relative w-full min-h-150 bg-amber-600 bg-cover bg-center flex items-center justify-center p-8 md:p-16" style={{ backgroundImage: `url(${sofa})` }}>
//       {/* Frosted Glass Overlay */}
//       <div className="absolute inset-4 md:inset-12 backdrop-blur-md border border-white/10 rounded-2xl p-8 md:p-16 text-white flex flex-col justify-between">
        
//         {/* Main Content Grid */}
//         <div className="grid grid-cols-1 md:grid-cols-3 px-20 py-20 gap-12 lg:gap-24 mb-16">
...
//             <p className="text-neutral-300 text-sm md:text-base max-w-xs leading-relaxed">
...
//           <div className="flex flex-col px-5 py-5 justify-between space-y-8 border-l-2 border-gray-200">
...
//           <div className="flex flex-col justify-between px-5 py-5 space-y-8 border-l-2 border-gray-300">
...
//       {/* Floating Side Button (Red Tab) */}
//       <div className="absolute right-0 bottom-32 bg-rose-500 p-3 text-white rounded-l-md shadow-lg cursor-pointer hover:bg-rose-600 transition-colors hidden md:block">
//         <div className="w-5 h-5 border border-white/80 rounded-sm flex items-center justify-center text-xs font-bold">
//           [ ]
//         </div>
//       </div>

//       {/* Scroll to Top Button */}
//       <div className="absolute right-8 bottom-8 bg-white text-neutral-900 p-3 rounded-md shadow-lg cursor-pointer hover:bg-neutral-100 transition-colors">
