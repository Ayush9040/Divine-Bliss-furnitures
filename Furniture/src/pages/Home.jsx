...
import project04 from '../assets/home-reference/project-04.webp';
import project05 from '../assets/home-reference/project-05.webp';
import project06 from '../assets/home-reference/project-06.webp';
import project07 from '../assets/home-reference/project-07.webp';
import project08 from '../assets/home-reference/project-08.webp';
import project09 from '../assets/home-reference/project-09.webp';
import project10 from '../assets/home-reference/project-10.webp';
import project11 from '../assets/home-reference/project-11.webp';
import project12 from '../assets/home-reference/project-12.webp';
...
const projects = [
  ['Harmony Residence', 'Architecture', 'Planning', project01],
  ['Grove Apartments', 'Architecture', 'Planning', project02],
  ['Luxe Heights', 'Furniture', 'Interior', project03],
    ...
    <main ref={pageRef} className="mink-home">
      <section ref={heroRef} className="mink-hero" aria-labelledby="home-hero-title">
        ...
        <div className="mink-wide-shell mink-hero-copy">
          <h1 id="home-hero-title" className="mink-hero-title">
            <span><SplitText>Where Style Meets</SplitText></span>
            <span><SplitText>Function</SplitText></span>
          </h1>
          <div className="mink-hero-info">
            <p>Interior Design That Defines<br />Modern Luxury</p>
      ...
      <section id="about" ref={aboutRef} className="mink-about mink-shell">
        <div className="mink-section-heading" data-reveal>
          <span className="mink-eyebrow"><i /> Smth Little About Us</span>
          <h2>Interior Design That Balances Beauty, Comfort, and Purpose in Every Detail</h2>
        </div>
      ...
      <section id="projects" className="mink-projects">
        <h2 className="mink-projects-title"><SplitText>Spaces We’ve Designed</SplitText></h2>
